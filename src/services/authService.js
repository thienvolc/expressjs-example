...
export default class AuthService {
    ...
    static #authenticateCredentials = async (email, password) => {
        const user = await UserService.requireUserByEmail(email);
    ...
    static #refreshTokenPairByUserInfo = async (userInfo) => {
        ...
        await AuthTokenKeyService.updateActiveRefreshTokenForUser(userInfo._id, tokenPair.refreshToken);
        return tokenPair;
    };
    ...
    static #verifyUserRefreshToken = async (refreshToken, userId) => {
        const authTokenKey = await AuthTokenKeyService.getAuthTokenKeyByUserIdOrThrow(userId);
